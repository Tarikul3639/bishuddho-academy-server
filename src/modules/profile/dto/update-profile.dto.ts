...
export class UpdateProfileDto {
  ...
  @ApiPropertyOptional({
    description: 'Secondary / alternative phone number',
    example: '01812345678',
  })
  @IsOptional()
  @Matches(BD_PHONE_REGEX, { message: BD_PHONE_MESSAGE })
  ...
  @IsOptional()
  @IsEnum(['Islam', 'Hinduism', 'Christianity', 'Buddhism', 'Other'], {
  ...
  @ApiPropertyOptional({
    description: 'Passport number (if any)',
    example: 'AB1234567',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'Academic roll number',
    example: '2021331039',
  })
  @IsOptional()
  @IsString()
  ...
  @IsDateString(
    {},
    { message: 'Admission date must be a valid ISO date string (YYYY-MM-DD).' },
  )
  admissionDate?: string;

  @ApiPropertyOptional({
    description: "Father's full name",
    example: 'Mohammad Islam',
  })
  @IsOptional()
  @IsString()
  fatherName?: string;
  ...
  @IsOptional()
  @IsEnum(['Father', 'Mother', 'Sibling', 'Spouse', 'Friend', 'Other'], {
  ...
  @ApiPropertyOptional({
    ...
    example: 'House 12, Road 5, Kafrul, Dhaka',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    ...
    example: 'Village: Char Fasson, Bhola, Barisal',
  })
  @IsOptional()
  @IsString()
