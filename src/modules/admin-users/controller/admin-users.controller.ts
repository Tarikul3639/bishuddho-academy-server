...
export class AdminUsersController {
  ...
  async findOne(
    ...
    return this.findUserDetailsService.findById(userId);
  }
  ...
  async unblockUser(
    ...
    return this.toggleUserBlockService.toggleBlock(userId, UserStatus.ACTIVE);
  }
  ...
  async resetPassword(
    ...
    return this.adminInitiatePasswordResetService.resetPassword(userId);
  }
}
